...
The dataset was accessed from Purdue University’s Laboratory for Advancing Sustainable Critical Infrastructure at https://engineering.purdue.edu/LASCI/research-data/outages. Throughout this project, we will explore the following question: Which factors, such as location, weather conditions, or population, are most strongly associated with major power outages of greater severity? We can answer this question through data cleaning and exploratory data analysis. After we perform those steps, we can build a predictive model to identify the cause of the next most severe outage.  
